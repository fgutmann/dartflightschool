...
["", "dartflightschool.dart", , K, {
  "": "",
  main: [function() {
    var system = new N.FileSystemAccess();
    H.IterableMixinWorkaround_forEach(system.list$1(system, "/"), new K.main_closure());
  ...
  main_closure: {
    ...
    call$1: function(element) {
      ...
      J.insertAdjacentText$2$x(t1, "beforeend", J.get$name$x(element));
      list.appendChild(t1);
    }
  }
},
...
["", "lib/localfilesystem.dart", , N, {
  "": "",
  FileSystemAccess: {
    "": "Protocol;",
    list$1: function(_, path) {
      var t1 = window;
      C.Window_methods._requestFileSystem$2(t1, 0, 31457280).then$1(new N.FileSystemAccess_list_closure());
      t1 = H.setRuntimeTypeInfo([], [O.File]);
      t1.push(new O.File("Error opening local file store", 0, false));
      return t1;
    }
  },
  FileSystemAccess_list_closure: {
    "": "Closure:10;",
    call$1: function(fs) {
      var files = H.setRuntimeTypeInfo([], [O.File]);
      J.readEntries$0$x(J.get$root$x(fs).createReader()).then$1(new N.FileSystemAccess_list__closure(files));
      return files;
    }
  },
  FileSystemAccess_list__closure: {
    "": "Closure:10;files_0",
    call$1: function(entries) {
      J.forEach$1$ax(entries, new N.FileSystemAccess_list___closure(this.files_0));
    }
  },
  FileSystemAccess_list___closure: {
    "": "Closure:10;files_1",
    call$1: function(entry) {
      var t1 = J.getInterceptor$x(entry);
      this.files_1.push(new O.File(t1.get$name(entry), 0, t1.get$isDirectory(entry)));
    }
  }
}],
["wsfp.abc", "lib/protocol.dart", , O, {
  "": "",
  File: {
    "": "Object;name>,size,isDirectory>"
  },
  Protocol: {
    "": "Object;"
  }
...
function dart_precompiled($collectedClasses) {
  ...
  FileSystemAccess.builtin$cls = "FileSystemAccess";
  if (!"name" in FileSystemAccess)
    FileSystemAccess.name = "FileSystemAccess";
  $desc = $collectedClasses.FileSystemAccess;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileSystemAccess.prototype = $desc;
  function FileSystemAccess_list_closure() {
  }
  FileSystemAccess_list_closure.builtin$cls = "FileSystemAccess_list_closure";
  if (!"name" in FileSystemAccess_list_closure)
    FileSystemAccess_list_closure.name = "FileSystemAccess_list_closure";
  $desc = $collectedClasses.FileSystemAccess_list_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileSystemAccess_list_closure.prototype = $desc;
  function FileSystemAccess_list__closure(files_0) {
    this.files_0 = files_0;
  }
  FileSystemAccess_list__closure.builtin$cls = "FileSystemAccess_list__closure";
  if (!"name" in FileSystemAccess_list__closure)
    FileSystemAccess_list__closure.name = "FileSystemAccess_list__closure";
  $desc = $collectedClasses.FileSystemAccess_list__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileSystemAccess_list__closure.prototype = $desc;
  function FileSystemAccess_list___closure(files_1) {
    this.files_1 = files_1;
  }
  FileSystemAccess_list___closure.builtin$cls = "FileSystemAccess_list___closure";
  if (!"name" in FileSystemAccess_list___closure)
    FileSystemAccess_list___closure.name = "FileSystemAccess_list___closure";
  $desc = $collectedClasses.FileSystemAccess_list___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileSystemAccess_list___closure.prototype = $desc;
  function File(name, size, isDirectory) {
    this.name = name;
    this.size = size;
